...
python3 main.py browserninja3 dt external >> results/browserninja3-dt-external.results.txt
python3 main.py browserninja3 randomforest external >> results/browserninja3-randomforest-external.results.txt
python3 main.py browserninja3 svm external >> results/browserninja3-svm-external.results.txt
python3 main.py browserninja3 nn external >> results/browserninja3-nn-external.results.txt
echo "===== BrowserNinja 3 Internal ====="
python3 main.py browserninja3 dt internal >> results/browserninja3-dt-internal.results.txt
python3 main.py browserninja3 randomforest internal >> results/browserninja3-randomforest-internal.results.txt
python3 main.py browserninja3 svm internal >> results/browserninja3-svm-internal.results.txt
python3 main.py browserninja3 nn internal >> results/browserninja3-nn-internal.results.txt
