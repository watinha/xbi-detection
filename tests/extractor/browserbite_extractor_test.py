...
10,12,12,14,14,16,16,33,77,78,79,70,71,72,73,74,75,76,90,90,90,90,90,90,90,90,90,90,1""")
        ...
        np.testing.assert_almost_equal(
                [1, 1, 1, 1, 1, 77,78,79,70,71,72,73,74,75,76,90,90,90,90,90,90,90,90,90,90], result['X'][0])
        np.testing.assert_almost_equal(
                [2, 17, 2, 2, 1, 77,78,79,70,71,72,73,74,75,76,90,90,90,90,90,90,90,90,90,90], result['X'][1])
...
10,12,12,14,14,16,16,33,77,78,79,70,71,72,73,74,75,76,90,90,90,90,90,90,90,90,90,90,1""")
        ...
        np.testing.assert_almost_equal(
                [1, 1, 1, 1, 1, 77,78,79,70,71,72,73,74,75,76,90,90,90,90,90,90,90,90,90,90], result['X'][0])
        np.testing.assert_almost_equal(
                [3, 3, 3, 3, 1, 70,71,72,71,72,80,90,74,75,76,90,9,90,90,90,90,90,90,90,90], result['X'][1])
        np.testing.assert_almost_equal(
                [2, 17, 2, 2, 1,77,78,79,70,71,72,73,74,75,76,90,90,90,90,90,90,90,90,90,90], result['X'][2])
